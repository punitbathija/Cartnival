      ...
      <div className="flex justify-center ">
        <nav className="self-center w-full max-w-7xl  ">
          <div className="flex flex-col justify-around items-center border-b-2">
            <h1 className="flex gap-6 justify-center align-middle m-auto text-center uppercase py-4 text-2xl font-sans font-bold px-14 drop-shadow-2xl">
              cartnival
              <svg
            ...
            <div className="flex space-x-5 text-sm md:text-[16px] cursor-pointer">
              <h1 className=" py-2 font-semibold hover:underline decoration-cyan-500">
                SignIn
              </h1>
              <h1 className=" py-2 font-semibold hover:underline decoration-cyan-500">
                SignUp
