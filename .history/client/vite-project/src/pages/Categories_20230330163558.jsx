  ...
  return (
    <div className="py-10">
      ...
      <div className="my-6 flex flex-wrap justify-center justify-items-center align-middle text-center m-auto">
        <div className="bg-[url('https://images.pexels.com/photos/2657668/pexels-photo-2657668.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] my-4 h-96 w-96 m-auto cursor-pointer border-2">
          Electronics
        </div>
