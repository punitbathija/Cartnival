...
const Login = () => {
  return (
    <div className="flex justify-center gap-24 text-center align-middle justify-items-center m-auto dark:bg-neutral-800 dark:text-white ease-in duration-200 font-mono">
      <div className="my-40">
        <form>
      ...
      <img
        ...
        className="h-[350px] w-[350px] my-32"
      ></img>
    </div>
  );
};
