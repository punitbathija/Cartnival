...
import StripeCheckoutfrom "react-stripe-checkout";
        ...
        <div className="md:border-2 md:flex min-h-[100vh]">
          ...
          <div className="m-auto">
            ...
            <div className="flex gap-4 justify-center m-auto py-6">
              ...
              <button
                className="flex gap-2 bg-orange-600 shadow-lg p-3 rounded-md hover:scale-110 hover:drop-shadow-xl text-center"
