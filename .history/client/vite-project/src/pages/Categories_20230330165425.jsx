  ...
  return (
    <div className="py-10">
      ...
      <div className="my-6 flex flex-wrap justify-center justify-items-center align-middle text-center m-auto">
        ...
        <div className="bg-[url('https://images.pexels.com/photos/2635038/pexels-photo-2635038.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-contain my-4 h-96 w-96 m-auto cursor-pointer border-2 flex justify-center justify-items-center align-middle text-center">
          <h1 className="m-auto text-3xl font-extrabold dark:bg-black bg-white opacity-100 p-2 rounded-md">
            Home and Kitchen
          </h1>
        </div>
