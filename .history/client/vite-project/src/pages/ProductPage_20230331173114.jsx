        ...
        <div className="border-2 md:flex">
          ...
          <div>
            ...
            <div className="flex gap-4 ">
              <button className="flex gap-2 bg-orange-600 shadow-lg p-3 rounded-md hover:scale-110 hover:drop-shadow-xl">
                ADD TO
                <svg
              ...
              <button className="flex gap-2 bg-amber-400 shadow-lg p-3 rounded-md hover:scale-110 hover:drop-shadow-xl text-center w-[150px]">
                BUY NOW
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
