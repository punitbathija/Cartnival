    ...
    <>
      <div className="h-[90vh] flex-col text-center md:px-32 px-4 py-12 m-auto dark:bg-neutral-800 dark:text-white ease-in duration-200 font-mono overflow-hidden">
        ...
        <div className="dark:text-black">
          ...
          <input
            className="p-4 rounded-full border-2 my-4 bg-transparent"
            type="text"
          ...
          <br />
          <button className="flex gap-2 bg-amber-400 shadow-lg p-2 rounded-md hover:scale-110 hover:drop-shadow-xl text-center m-auto">
            Submit
          </button>
        </div>
      </div>
