  ...
  return (
    <div className="py-10 cursor-default dark:bg-neutral-800 dark:text-white ease-in duration-200 font-mono overflow-hidden">
      <div className="my-6 flex flex-wrap justify-center justify-items-center align-middle text-center m-auto">
        <div className="bg-[url('https://images.pexels.com/photos/4533076/pexels-photo-4533076.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-cover my-4 h-96 w-86 m-auto cursor-pointer border-2 flex justify-center justify-items-center align-middle text-center hover:scale-105">
