...
const Electronics = () => {
  ...
  return (
    <>
      <h1 className="p 24x-cyan-500 text-3xl md:text-4xl font-extralight p-24 dark:bg-neutral-800 dark:text-white ease-in duration-200 font-mono overflow-hidden">
        Electronics
      </h1>
