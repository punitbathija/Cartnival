...
const MyOrders = () => {
  ...
  return (
    <div className="justify-center gap-36 text-center align-middle justify-items-center m-auto dark:bg-neutral-800 dark:text-white ease-in duration-200 font-mono min-h-[85.5vh] ">
