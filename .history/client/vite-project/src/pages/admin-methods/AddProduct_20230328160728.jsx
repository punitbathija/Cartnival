...
function AddProduct() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      formDataWithPhotos.append("photos", formData.photos);

      formDataWithPhotos.append("category", category);
      formDataWithPhotos.append("brand", brand);
      formDataWithPhotos.append("quantity", quantity);
