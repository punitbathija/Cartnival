  ...
  return (
    <div className="md:flex m-auto dark:bg-neutral-800 dark:text-white ease-in duration-200 font-mono">
      <div className="">
        ...
        {tokenData && (
          <div className="border-2 py-4 flex-col text-center justify-center justify-items-center align-middle m-auto">
            ...
            <img src={tokenData.orderItems[0].photo} className="m-auto" />
          </div>
        )}
      </div>
    </div>
