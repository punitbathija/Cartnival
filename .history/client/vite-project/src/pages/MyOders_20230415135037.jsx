...
const MyOrders = () => {
  ...
  return (
    <div className="flex justify-center gap-36 text-center align-middle justify-items-center m-auto dark:bg-neutral-800 dark:text-white ease-in duration-200 font-mono min-h-[85.5vh] ">
      ...
      <div className="md:flex my-2">
        ...
        {orderData &&
          orderData.map((order) => {
            return (
              <div
                className="border-2 my-4 h-106 w-96 cursor-default text-center flex flex-col gap-2 mx-4"
                key={order._id}
              >
                <h1>
