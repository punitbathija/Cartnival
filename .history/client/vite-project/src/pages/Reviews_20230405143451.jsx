        ...
        <div>
          ...
          {user && (
            <button
              ...
              className="flex gap-2 text-black bg-red-500 my-2 shadow-lg p-2 rounded-md hover:scale-110 hover:drop-shadow-xl text-center m-auto"
            >
              <svg
