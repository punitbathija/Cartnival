...
function Footer() {
  return (
    <div className="border-2 bg-gray-50 text-center text-goodwhite md:text-2xl w-full py-5  dark:bg-neutral-800 dark:text-white ease-in duration-200 font-mono z-10">
